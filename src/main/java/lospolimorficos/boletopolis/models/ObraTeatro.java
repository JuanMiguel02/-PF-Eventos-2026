...
public class ObraTeatro extends Evento{
    ...
    public ObraTeatro(String nombre, String descripcion, Ciudad ciudad, LocalDateTime fecha, EstadoEvento estadoEvento, Recinto recinto, javax.xml.datatype.Duration duracion) {
        super();
    }
}
