...
/**
 * <p><b>VendidoState</b></p>
 *
 * <p>Esta implementación de {@link EstadoAsientoState} define la apariencia visual
 * de un asiento cuando se encuentra en el estado {@link EstadoAsiento#VENDIDO}.</p>
 */
public class VendidoState implements EstadoAsientoState {

    /**
     * <p><b>Aplica la configuración visual para un asiento VENDIDO.</b></p>
     *
     * <p>Un asiento vendido se representa con un color de relleno rojo sólido y un borde negro.</p>
     *
     * <p><b>Pasos:</b></p>
     * <ol>
     *     <li>Limpia cualquier estilo CSS previo del {@code rectangulo}.</li>
     *     <li>Establece el color de relleno a {@link Color#RED}.</li>
